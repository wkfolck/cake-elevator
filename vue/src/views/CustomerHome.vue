<template>
  <div id="login" class="text-center">
      <h1 id="welcomeTo">Welcome To Cake Elevator</h1>
      <h3>Where we seek to "elevate" your taste buds!</h3>
...
<div class="review">
<p>Wow! I love this bakery! If I could eat here everyday, I would. The cake is always moist and baked to perfection. Some bakeries make their buttercream too sweet, but Cake Elevator’s buttercream is perfect! I’d definitely recommend!</p>
<p class="reviewer">– Susie Lee</p>
</div>

<div class="container">

	<h1 class="heading homePageLinks" id="cAndSCakesHeading"><strong><router-link v-bind:to="{ name: 'orderstandardcake' }">Standard Cakes </router-link> <span>&</span><span> <router-link v-bind:to="{ name: 'ordercustomcake' }">Custom Cakes </router-link></span></strong></h1>
...
<div class="review">
<p>I ordered a 2-tier round cake for my daughter's graduation party and the cake was so delicious and beautiful… it stole the show. I will definitely be ordering again.</p>
<p class="reviewer">–Tammy Jones</p>
</div>
<div class="review">
<p>I’m more of a pie guy but I love their chocolate cake!</p>
<p class="reviewer">–Patrick Star</p>
</div>
  </div>
</template>
